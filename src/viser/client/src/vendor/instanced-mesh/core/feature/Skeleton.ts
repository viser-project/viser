...
declare module "../InstancedMesh2.js" {
  interface InstancedMesh2 {
    ...
    setBonesAt(
      id: number,
      updateBonesMatrices?: boolean,
      excludeBonesSet?: Set<string>,
    ): void;
    /** internal */ multiplyBoneMatricesAt(
...
InstancedMesh2.prototype.setBonesAt = function (
  id: number,
...
InstancedMesh2.prototype.multiplyBoneMatricesAt = function (
  instanceIndex: number,
  boneIndex: number,
  m1: Matrix4,
  m2: Matrix4,
