...
// shared layout, so dropping panes in, reordering tabs, tearing a pane out
// (to float, or to merge with the host/parent panel), and dropping a whole
// snapped stack (which collapses into a series of tabs) all reuse the exact
// same layout ops, hit-testing, and pointer-drag controller as everything
// else -- there is no difference between "standard" and "nested" panes.
//
